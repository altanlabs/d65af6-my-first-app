    ...
    <div className="container mx-auto px-4 py-16 space-y-32">
      ...
      >
        ...
        >
          ...
          {/* Example: <Testimonial name="John Doe" feedback="Amazing service!" /> */}
        </motion.div>
      </motion.section>
      ...
      >
        <motion.div variants={fadeInUp}>
          ...
          <p className="mx-auto mt-4 max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
            Reach out to us for any inquiries or to start a project.
          </p>
          <div className="mt-6 flex justify-center gap-4">
            <Button size="lg" variant="default" onClick={() => navigate('/contact')}>
              Contact Us
            </Button>
